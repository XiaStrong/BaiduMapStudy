...
@interface PlaceViewController ()<UIAlertViewDelegate,BMKMapViewDelegate,BMKRouteSearchDelegate>
{
    BMKRouteSearch* _routesearch;//路径搜索
...
- (IBAction)sureClick:(id)sender {
    ...
    UIAlertView *alert=[[UIAlertView alloc]initWithTitle:@"路径方式" message:nil delegate:self cancelButtonTitle:@"取消" otherButtonTitles:@"公交",@"驾乘",@"步行", nil];
    alert.tag=10;
    [alert show];
